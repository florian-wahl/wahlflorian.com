...
![4 Collaboration Models between Fintechs & Incumbent Financial Institutions](https://miro.medium.com/v2/resize:fit:1400/0*37aDlWhUyABDaZjE)
...
Fintechs can provide tools and services to the bank more in the form of a vendor relationship. For instance, banks can use the services of third-party companies to enhance their customer experience. This is the case with [Personetics](https://personetics.com/), a fintech providing personalized customer engagement services to financial institutions like U.S. Bank, BMO, or [Santander](https://personetics.com/resource-center/how-santander-spain-humanizes-the-banking-experience-with-ai-self-driving-finance/).
...
One example is the [Deutsche Bank + Traxpay](https://www.db.com/news/detail/20200724-deutsche-bank-to-invest-in-financing-platform-traxpay?language_id=1) partnership. In 2020, Deutsche Bank decided to extend its trade financing capabilities and is now using Traxpay’s platform technology to expand its supply chain finance offering.
...
One instance of this approach is [Mint recommending credit cards](https://mint.intuit.com/credit-cards/) through its channels. These credit card offers were personalized to the consumers based on the insights Mint was able to gather on the consumer through their personal financial management product.
...
Organizations such as [Cross River Bank](https://www.crossriver.com/) or [Green Dot Bank](https://www.greendot.com/) are thriving with that model, offering a vast array of banking-as-a-service capabilities to other fintechs. [Affirm’s savings accounts](https://helpcenter.affirm.com/s/topic/0TO3t000000tPWMGA2/about-affirm), for example, are held with Cross River Bank.
...
At the same time, new challenger models have also emerged and we see incumbents bringing to markets new products (although [getting shut down](https://www.cnbc.com/2022/10/18/goldman-sachs-pivot-from-marcus-shows-that-disrupting-retail-banking-is-hard.html), Marcus is a good example of such an attempt), or big tech companies launching into the banking space (Apple launching its Apple Card, and more recently the [Apple Pay Later](https://www.cnbc.com/video/2022/06/06/apple-announces-buy-now-pay-later-program-called-apple-pay-later.html) product).
