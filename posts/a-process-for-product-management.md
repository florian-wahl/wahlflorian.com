...
When we talk about product management, we usually look at frameworks and methodologies to help us build better products. This is done either through a more robust [product strategy](/@flwahl/a-framework-for-product-strategy-68ddabe8cb6) or by taking a different look at [key components](/@flwahl/breaking-down-the-digital-product-layers-70d7590a6dcb) that constitute digital products.
...
![A process for product management: intake, prioritize, build, test, launch, iterate, and retire.](https://miro.medium.com/v2/resize:fit:1400/1*yg7tmTyUqldSMY6ITNfsLQ.png)
...
*   _A problem statement is documented_
*   _A high-level business case is created_
*   _A potential MVP is identified_
...
Now, prioritization is one of the most challenging steps in product management and tends to be a complex task for an organization/product manager to accomplish. Lots of factors come into play and influence the decision-making process. [Prioritization methodologies and frameworks](https://roadmunk.com/guides/product-prioritization-techniques-product-managers/) can become handy (e.g., RICE, MoSCoW, value vs. effort). The deliverable you are looking for is a **ranked list of ideas**. This prioritized list is what composes your team's **backlog** and **roadmap**.
...
It’s at this stage of the product management process that an idea will become what I call an _initiative_. An initiative differs from an idea in the sense that an initiative has been prioritized, and a plan is behind it.

Here are some of the outcomes you should have after the prioritize phase:

*   _Ideas_ _are prioritized_
*   _Initiates are defined on your roadmap_
*   _The business plan is finalized_
...
*   _The MVP/feature is built_
*   _The documentation is updated_
...
*   _The MVP is tested and finalized_
*   _Feedback is captured and addressed_
*   _A go-to-market plan is created_
*   _A go/no-go decision is made on the launch_
...
*   _How is the market responding?_
*   _Are customers happy?_
*   _How is the product performing compared to the business case?_
...
*   _The product is made generally available_
*   _A process to capture customer feedback is in place_
*   _The performance of the product is monitored_
...
*   _Next releases are being planned_
*   _Feedback is being captured, reviewed, and addressed_
*   _Results are measured_
