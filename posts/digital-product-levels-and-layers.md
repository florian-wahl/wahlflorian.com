...
This first model is quite common when you are looking for product layers. It is a simplified view of [Kotler’s Five Product Levels](https://www.cgma.org/resources/tools/cost-transformation-model/kotlers-five-product-level-model.html) and looks at three main levels of product: the **core** product, the **actual** product, and the **augmented** product.

![Levels of product value](https://miro.medium.com/v2/resize:fit:1400/1*iO0ixU8AcImt58QbPe9fNQ.png)
...
To think through that, [Maslow’s Hierarchy of Needs](https://www.simplypsychology.org/maslow.html) gives a good view of fundamental human needs. By order of priority:

1.  **Physiological**—basics for human survival, e.g., air, food, drink, shelter
2.  **Safety** — order and security, e.g., police, medical care
3.  **Love & belonging** — emotional needs for interpersonal relationships, e.g., friendship, intimacy, trust
4.  **Esteem** — for yourself and from others, e.g., dignity, achievement, status, prestige
5.  **Self-actualization** — seeking personal growth and experiences, e.g., achieving your potential, learning, self-development, creative activities
...
![Digital product layers](https://miro.medium.com/v2/resize:fit:1400/1*e5QwFJv2SJDITKdr6TqrBA.png)
...
Similarly to the _actual product_ we discussed in the previous framework, the application layer is usually what a user thinks about when picturing your digital product.
...
Again, we can draw a direct parallel between Kotler’s _augmented product_ and this service layer.
...
![Use case layers](https://miro.medium.com/v2/resize:fit:1400/1*2ZWs4u5SwKDR-SBynC07HA.png)
...
If you are interested to go further into the subject of strategy, I am discussing a **framework for product strategy** in more detail in a separate [article](https://medium.com/@flwahl/a-framework-for-product-strategy-68ddabe8cb6).
